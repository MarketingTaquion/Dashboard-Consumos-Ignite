...
export const MOCK_CLIENTS: ClientData[] = [
  {
    ...
    cpl: {
      meta: { target: 850, real: 910 },
      google: { target: 1200, real: 1340 },
      linkedin: { target: 2600, real: 2450 },
    },
    health: [
  ...
  },
  {
    ...
    cpl: {
      meta: { target: 450, real: 610 },
      google: { target: 700, real: 680 },
      linkedin: { target: 3000, real: 3100 },
    },
    health: [
  ...
  },
  {
    ...
    cpl: {
      google: { target: 1800, real: 1750 },
      meta: { target: 1100, real: 1050 },
      linkedin: { target: 2400, real: 2200 },
    },
    health: [],
  },
  {
    ...
    mix: { meta: 100 },
    cpl: {
      meta: { target: 2200, real: 2380, label: "CPME" },
    },
    health: [

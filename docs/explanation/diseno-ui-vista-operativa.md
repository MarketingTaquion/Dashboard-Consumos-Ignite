...
Los presets sin datos históricos reales (Hoy, Ayer, Últimos 7/14/28 días, Mes anterior) están visualmente presentes pero deshabilitados con la etiqueta "pronto" — se prefirió esa honestidad sobre simular que cambian algo cuando en realidad todo el dataset sigue siendo el mismo "Mes en curso" mock.
